...
class TestEventPanner:
    ...
    @pytest.mark.parametrize('event_title, expected_meeting_id', [
        ("event3", 4)
    ])
    ...
    @pytest.mark.parametrize(('original_event_title, chosen_meeting_id, '
    ...
    def test_run(self, original_event_title, chosen_meeting_id,
        ...
        self.test_execute_choice(original_event_title, chosen_meeting,
                                 expected_meeting_deleted_ids, expected_possible_participants_deleted_ids)
